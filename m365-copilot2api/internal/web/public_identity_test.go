...
func TestProtocolAdaptersSanitizeAssistantIdentity(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "responses", write: func(rr *httptest.ResponseRecorder) { writeResponsesResult(rr, "gpt-5.6-sol", false, src, nil) }},
		{name: "responses_stream", write: func(rr *httptest.ResponseRecorder) { writeResponsesResult(rr, "gpt-5.6-sol", true, src, nil) }},
